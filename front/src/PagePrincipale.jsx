...
function PagePrincipale({ onUserClick, onLoginClick, setIsConnected, setCurrentPage }) {
  ...
  const [userCoins, setUserCoins] = useState(0); // État pour stocker le nombre de pièces
    ...
    try {
      ...
      if (fetchedAccount.length > 0) {
        ...
        if (selectedAccount) {
          ...
          setUserCoins(selectedAccount.coins || 0); // Initialisation de userCoins
        }
      }
    } catch (error) {
  ...
  // Récupérer les salles publiques
  ...
  // Gérer les inputs utilisateurs et passer à la game Room
        ...
        <nav className="navbar navbar-expand-lg sticky-top" style={gradientStyle}>
          <div className="container-fluid">
            ...
            <div className="ms-auto me-4 position-relative user-hover-area d-flex align-items-center">
              <span className="text-white me-4">{userCoins} Pièces</span> {/* Affichage des pièces */}
              {compte.avatar ? (
                <img
                  src={compte.avatar}
            ...
            <div className="col-md-6">
              <div className="game-card">
                ...
                <div className="input-group mb-3 w-75 mx-auto">
                  ...
                  />
                  <button className="btn" onClick={() => handleJoinRoom(roomCode)}>Rejoindre</button>
                </div>
              </div>
            </div>
            {/* Jeu2 */}
